    ...
    <div style={{ fontFamily: "Impact" }} className='bg-black text-white'>
      <div className="relative bg-cover bg-center transform -translate-y-10">
        ...
        <div className="absolute inset-0  text-white">
          ...
          {/* Links Container */}
          <div className="flex justify-center space-x-20 mt-10 uppercase text-2xl ">
            <a href="#link1" className="hover:underline">Services</a>
            <a href="#link2" className="hover:underline">Projects</a>
            <a href="#link3" className="hover:underline">Venues</a>
            <a href="#link4" className="hover:underline">About Us</a>
          </div>

          <h1 className='uppercase text-center mt-5' style={{ fontFamily: "Arial" }}>
      ...
      <div className='text-white flex justify-end -mt-10'>
        <div className='uppercase inline-block mr-44'>
          <h1 className='text-7xl leading-normal'>Everyday. We Work. <br /><span className='text-8xl text-primary'>Built Beyond Limits.</span></h1>
        </div>
      </div>


      <div className='w-11/12 mx-auto uppercase flex justify-between text-white my-20' style={{ fontFamily: "Arial" }}>
      ...
      <div className='w-11/12 my-10 mx-auto'>
        <h1 className='uppercase text-6xl text-center text-primary'>What We do</h1>
        ...
        <div className='flex flex-wrap justify-around uppercase text-white w-4/5 mx-auto gap-40'>
          ...
          <a href='#' className='uppercase text-6xl text-center text-primary border-b-2 border-primary pb-1'>View All Services</a>
      ...
      <div className='w-10/12 mx-auto text-white flex justify-around items-center my-5'>
        <h2 className=''>@2015</h2>
        <div className=' w-2/5'>
          <img src={CubeImage} alt="Cube Image" className="w-full object-contain" />
        </div>
        <h2>@2024</h2>
      </div>
      ...
      <div className='w-4/5 mx-auto flex justify-around uppercase my-32'>
      ...
      <div className='pb-16 w-11/12 mx-auto mt-48'>
        ...
        <div className='flex justify-between items-end uppercase'>
          <h1 className='text-primary border-b-8 border-primary w-2/5 pb-2 text-mega leading-none'>Lets Build.</h1>
          <div className='text-primary text-right text-3xl'>
            <h1>IG_BUILTANDCOMPANY</h1>
            <h1>HELLO@BUILTANDCOMPANY.COM</h1>
          </div>
        </div>

        <h1 className='text-center uppercase text-2xl mt-20'>© 2024 THE DRIP GROUP INC</h1>
      </div>
